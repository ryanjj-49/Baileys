...
const makeSocket = (config) => {
    ...
    const pnFromLIDUSync = async (jids) => {
        ...
        const uqTagId2 = (0, Utils_1.generateMdTagPrefix)();
        let epoch2 = 1;
        const generateMessageTag2 = () => `${uqTagId2}${epoch2++}`;
        ...
        const iq = {
            ...
            content: [{ tag: 'usync', attrs: { context: usyncQuery.context, mode: usyncQuery.mode, sid: generateMessageTag2(), last: 'true', index: '0' }, content: [queryNode, listNode] }]
        };
        try {
            ...
            logger.warn({ e }, 'pnFromLIDUSync failed');
        }
        return [];
    };
